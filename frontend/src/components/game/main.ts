...
//                     this.ballEntities = this.add.rectangle(
//                         0,
//                         player.y,
//                         15,
//                         15,
//                         0x006600
//                     );
//                     this.physics.add.existing(this.ballEntities);
//                 }
...
//                 this.scoreEntities.setText(
//                     score[0].toString() + "     " + score[1].toString()
//                 );
//             });
//             if (this.ballEntities) {
//                 this.room.onMessage("ball-start", (data) => {
//                     this.ballEntities.body.setVelocity(data);
//                 });
//                 this.room.send("ball", this.ballEntities);
//                 if (this.ballEntities.x >= this.game.canvas.width) {
//                 }
//             }
//         }
//     }
